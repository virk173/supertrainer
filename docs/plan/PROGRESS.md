...
- [ ] 2.2 Blurred preview generator (foods table + allergen block + preview UI + conversion)
- [ ] 2.3 Consent gate (blocking, evidence trail, PDF)
- [ ] 2.4 PWA install + notification walkthrough
