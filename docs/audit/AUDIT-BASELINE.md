# Audit baseline — Phases 0–5 (Training Split Designer shipped)

**Baseline commit:** `fb74b09` (main, 2026-07-23) — "Phase 5 — Training Split Designer (#16)". (Prior baselines: `7bd1aeb` Phase 4 Diet Plan Generator #14; `2baacaf` Phase 3 Adherence Ledger #10; `8748b59` audit PROPOSE-ONLY features #8; `1e63677` pre–Phase 3 hardening #7.)
...
- Establish the diff to review: `git diff <baseline-or-prev-phase-merge>..HEAD` (start from `fb74b09` for Phase 6), or the phase's file set. Do NOT read/scan Phases 0–5 code except where the new phase directly touches it.
