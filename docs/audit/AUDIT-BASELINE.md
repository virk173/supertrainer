# Audit baseline — Phases 0–7 (The Trainer Dashboard shipped)

**Baseline commit:** `8cfcb57` (main, 2026-07-24) — "Phase 7 — The Trainer Dashboard (#21)". (Prior baselines: `7b74f9f` Phase 6 Native Messaging & AI Comms #18; `fb74b09` Phase 5 Training Split Designer #16; `7bd1aeb` Phase 4 Diet Plan Generator #14; `2baacaf` Phase 3 Adherence Ledger #10; `8748b59` audit PROPOSE-ONLY features #8; `1e63677` pre–Phase 3 hardening #7.)
...
- Establish the diff to review: `git diff <baseline-or-prev-phase-merge>..HEAD` (start from `8cfcb57` for Phase 8), or the phase's file set. Do NOT read/scan Phases 0–7 code except where the new phase directly touches it.
